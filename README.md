...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/globetracker)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/globetracker
```

A live public deployment of this template is available at [https://globetracker.templates.workers.dev](https://globetracker.templates.workers.dev)
